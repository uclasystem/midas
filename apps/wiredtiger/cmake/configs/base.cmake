...
set(default_enable_midas ${HAVE_LIBMIDAS})
...
config_bool(
    ENABLE_MIDAS
    "Use Midas as the internal cache manager"
    DEFAULT ${default_enable_midas}
    DEPENDS "HAVE_LIBMIDAS"
    # Specifically throw a fatal error if a user tries to enable midas without
    # actually having the library available (as opposed to silently defaulting to OFF).
    DEPENDS_ERROR ON "Failed to find midas library"
)
